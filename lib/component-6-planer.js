...
class Planer {
  constructor (id, data, api) {
    ...
    this.persistentStateMacroId = `domotic_heating_dashboard_${this.id}`
  ...
  initialize () {
    ...
    this.api.notifyMacroListeners(null, {
      id: this.persistentStateMacroId,
      data: {},
    ...
    // TODO !3: au moment db.deleteComponent (coté serveur seulement), declencher : cancelJob(this.scheduledJob)
