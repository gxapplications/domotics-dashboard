...
const actions = function (api, reply, page, component, action = null, payload = {}) {
  ...
  if (actionKey === 'inspect_temperatures') {
    ...
    const volatileConfiguration = modelMiddleWare.fixPayload(payload)
    ...
    const {minmax, value} = modelMiddleWare.fixPayload(payload)
    ...
    const newConfiguration = Object.assign({}, configuration, modelMiddleWare.fixPayload(payload))
